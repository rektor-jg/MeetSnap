...
export const MeetsnapLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.22 14.22L8.2 13.64c-.39-.39-.39-1.02 0-1.41l2.58-2.58c.39-.39 1.02-.39 1.41 0l2.58 2.58c.39.39.39 1.02 0 1.41l-2.58 2.58c-.38.39-1.02.39-1.41 0zM17 14h-2.5c-.28 0-.5-.22-.5-.5v-3c0-.28.22-.5.5-.5H17c.55 0 1 .45 1 1v2c0 .55-.45 1-1 1z" />
...
export const SoundWaveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M3 10v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1zm5 2v2a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1zm5-4v6a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-1a1 1 0 0 0-1 1zm5-3v8a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1a1 1 0 0 0-1 1z"/>
  </svg>
);

export const PlayIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M4.5 5.653c0-1.426 1.529-2.33 2.779-1.643l11.54 6.648c1.295.746 1.295 2.54 0 3.286L7.279 20.99c-1.25.717-2.779-.217-2.779-1.643V5.653z" clipRule="evenodd" />
  </svg>
);
...
export const ProcessingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0 0v-4.992m0 0h-4.992" />
  </svg>
);
...
export const YoutubeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M12.0002 3.82465C12.0002 3.82465 6.70227 3.82465 4.88727 4.38065C3.47327 4.79665 2.37327 5.89765 1.95627 7.31165C1.40027 9.12665 1.40027 12.0007 1.40027 12.0007C1.40027 12.0007 1.40027 14.8747 1.95627 16.6897C2.37227 18.1037 3.47327 19.2037 4.88727 19.6207C6.70227 20.1767 12.0002 20.1767 12.0002 20.1767C12.0002 20.1767 17.2982 20.1767 19.1132 19.6207C20.5272 19.2047 21.6272 18.1037 22.0442 16.6897C22.6002 14.8747 22.6002 12.0007 22.6002 12.0007C22.6002 12.0007 22.6002 9.12665 22.0442 7.31165C21.6282 5.89765 20.5272 4.79665 19.1132 4.38065C17.2982 3.82465 12.0002 3.82465 12.0002 3.82465ZM9.73327 15.1757V8.82565L15.6232 12.0007L9.73327 15.1757Z"></path>
    </svg>
);
