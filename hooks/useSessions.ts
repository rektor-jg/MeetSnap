    ...
    const sampleSession1: Session = {
      ...
      artifacts: {
        ...
        summaryMd: {
          ...
          pl: "### TL;DR\n\nZespół omówił plan na trzeci kwartał dla Projektu Phoenix. Prototyp backendu jest ukończony i stabilny. Zespół frontendu ma niewielkie opóźnienie z powodu problemów z biblioteką UI, ale spodziewa się nadrobić zaległości. Głównym wyzwaniem jest złożony komponent do wizualizacji danych w czasie rzeczywistym.\n\n### Zadania do wykonania\n\n- **Zespół Frontend:** Priorytetowe potraktowanie i dostarczenie demonstracji komponentu wizualizacji danych do końca miesiąca.\n- **Zespół Backend:** Przygotowanie propozycji strategii wdrożenia bezserwerowego, w tym analizy kosztów i korzyści, do przeglądu w piątek."
        },
        segments: [
    ...
    const sampleSession2: Session = {
        ...
        artifacts: {
          ...
          summaryMd: {
            ...
            en: "### TL;DR\n\nThe team discussed the concept for the 'Urban Discoveries' summer marketing campaign, aimed at people aged 20-35. The campaign will promote local attractions through social media and include a gamification element.\n\n### Action Items\n\n- **Ania and Piotr:** Prepare a detailed outline of the 'Urban Discoveries' campaign concept, including the gamification element, for this Wednesday."
          },
          segments: [
    ...
    const sampleSession3: Session = {
        ...
        artifacts: {
          ...
          summaryMd: {
            ...
            pl: "### TL;DR\n\nZespół omówił API do uwierzytelniania użytkowników. Przepływ OAuth 2.0 jest prawie ukończony, w oczekiwaniu na poprawkę logiki odświeżania tokenów. Endpoint do pobierania profili użytkowników jest prawie gotowy, a ostateczny schemat danych zostanie wkrótce opublikowany. Zespół podkreślił potrzebę solidnej i spójnej obsługi błędów.\n\n### Zadania do wykonania\n\n- **Mark:** Rozwiązać problem z walidacją wygaśnięcia tokena po stronie serwera do końca dnia.\n- **Mówca 3:** Opublikować ostateczny schemat dla endpointu profili użytkowników na Confluence do jutra rano.\n- **Wszyscy:** Przejrzeć proponowane kody błędów API udokumentowane w specyfikacji."
          },
          segments: [
